...
function provideCanvas<TBase extends GConstructor<TypstDocument & TypstSvgDocument>>(Base: TBase)
...
function provideSvg<TBase extends GConstructor<TypstDocument & TypstCanvasDocument>>(Base: TBase)
...
describe("mixinClass", () => {
    it("doMixin", () => {
        const T = provideSvg(provideCanvas(TypstDocument as GConstructor<TypstDocument & TypstSvgDocument>));
        const t = new T();
